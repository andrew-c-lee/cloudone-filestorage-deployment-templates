...
def append_trigger_topic(function, context):
    """ Appends the Pub/Sub event trigger. """

    project_id = context.env['project']
    topic = context.properties['triggerTopic']

    function['properties']['eventTrigger'] = {
        'eventType': 'providers/cloud.pubsub/eventTypes/topic.publish',
        'resource': 'projects/{}/topics/{}'.format(project_id, topic)
    }

    if context.properties.get('retryOnFailure', False):
        function['properties']['eventTrigger']['failurePolicy'] = {
            'retry': {}
        }
...
def append_trigger(function, context):
    ...
    if 'triggerTopic' in context.properties:
        return append_trigger_topic(function, context)
